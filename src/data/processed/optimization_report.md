...
|------|-------------------|----------|
| 1 | `sma50_vs_sma200` | важный признак |
| 2 | `rsi_14` | индикатор RSI |
| 3 | `dollar_vol_ratio` | важный признак |
| 4 | `dollar_volume` | важный признак |
| 5 | `volume_ratio` | аномалия объема |
| 6 | `price_vs_low20` | важный признак |
| 7 | `return_5d` | важный признак |
| 8 | `volume_z_score` | важный признак |
| 9 | `macd_signal` | важный признак |
| 10 | `momentum_60d` | долгосрочный тренд |
